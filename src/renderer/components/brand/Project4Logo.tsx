/**
 * Project4Logo - Brand animated logo component
 * Used across the app for loading states and branding
 *
 * Usage:
 *   <Project4Logo size="sm" />      // 28px - for inline/small areas
 *   <Project4Logo size="md" />      // 48px - for medium contexts
 *   <Project4Logo size="lg" />      // 96px - for large displays (like splash)
 *   <Project4Logo size={64} />      // custom size in pixels
 */

interface Project4LogoProps {
...
export function Project4Logo({ size = 'md', className = '' }: Project4LogoProps) {
  ...
  return (
    ...
    >
      {/* Outer glow ring */}
      <div className={`absolute inset-0 rounded-full bg-primary/20 ${styles.blur} brand-breathe`} />

      {/* Main ring */}
      <div
        className={`relative rounded-full ${styles.border} border-primary/60 flex items-center justify-center brand-glow`}
        style={{ width: pixelSize, height: pixelSize }}
      >
        {/* Inner glow */}
