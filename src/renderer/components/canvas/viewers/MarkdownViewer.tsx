...
/**
 * Resolve relative image paths to project4-file:// protocol URLs
...
function resolveImageSrc(src: string | undefined, basePath: string): string {
  ...
  // Resolve relative paths to project4-file:// protocol
  if (src.startsWith('./')) {
    return `project4-file://${basePath}/${src.slice(2)}`
  }
  ...
  if (src.startsWith('../')) {
    ...
    return `project4-file://${parts.join('/')}/${srcParts.join('/')}`
  }

  if (src.startsWith('/')) {
    return `project4-file://${src}`
  }

  // Relative path without prefix
  return `project4-file://${basePath}/${src}`
}
          ...
          <div className="prose prose-invert max-w-none p-6 sm:p-8">
            <ReactMarkdown
              ...
              components={{
                ...
                // Style images - resolve relative paths using project4-file:// protocol
                img({ src, alt }) {
                  return (
                    <img
