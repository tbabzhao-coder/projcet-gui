      ...
      <div className={isCompact ? '' : 'max-w-3xl mx-auto'}>
        ...
        <div
          className={`
            ...
            ${isFocused
              ? 'ring-2 ring-primary/50 bg-card shadow-md'
              : 'bg-card border border-border shadow-sm hover:shadow-md'
            }
            ${isGenerating ? 'opacity-60' : ''}
            ${isDragOver ? 'ring-2 ring-primary bg-primary/5 input-drag-over' : ''}
          `}
        ...
        >
          ...
          <div className="px-3 pt-3 pb-1">
            <textarea
              ...
              placeholder={placeholder || t('Type a message, let Project4 help you...')}
...
function InputToolbar({
  ...
  return (
    <div className="flex items-center justify-between px-2 pb-2 pt-1">
      {/* Left section: attachment button + thinking toggle - DISABLED */}
      <div className="flex items-center gap-1">
        {/* Attachment menu - DISABLED */}
