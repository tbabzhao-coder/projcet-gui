 ...
 *
 * This module provides AI-controlled browser capabilities for Project4.
...
You can now control Project4's embedded real browser. All browser tools are provided via MCP server "ai-browser".
