 ...
 */
declare const __PROJECT4_GA_MEASUREMENT_ID__: string
declare const __PROJECT4_GA_API_SECRET__: string
declare const __PROJECT4_BAIDU_SITE_ID__: string
...
const PROVIDER_CONFIG = {
  baidu: {
    siteId: __PROJECT4_BAIDU_SITE_ID__
  },
  ga: {
    measurementId: __PROJECT4_GA_MEASUREMENT_ID__,
    apiSecret: __PROJECT4_GA_API_SECRET__
  }
}
