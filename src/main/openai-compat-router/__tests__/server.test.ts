...
describe('API Type Resolution', () => {
  ...
  describe('shouldForceStream', () => {
    ...
    beforeEach(() => {
      ...
      delete process.env.PROJECT4_OPENAI_FORCE_STREAM
    })
    ...
    it('should return true for "1"', () => {
      process.env.PROJECT4_OPENAI_FORCE_STREAM = '1'
      expect(shouldForceStream()).toBe(true)
    })

    it('should return true for "true"', () => {
      process.env.PROJECT4_OPENAI_FORCE_STREAM = 'true'
      expect(shouldForceStream()).toBe(true)
    })

    it('should return true for "yes"', () => {
      process.env.PROJECT4_OPENAI_FORCE_STREAM = 'yes'
      expect(shouldForceStream()).toBe(true)
    })

    it('should return false for other values', () => {
      process.env.PROJECT4_OPENAI_FORCE_STREAM = 'false'
      expect(shouldForceStream()).toBe(false)
    })
  })
})
