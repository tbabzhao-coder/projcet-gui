 ...
 *
 * Configures Playwright to test the Project4 Electron application.
...
function getAppPath(): string {
  ...
  if (platform === 'darwin') {
    ...
    return path.join(projectRoot, 'dist/win-unpacked/Project4.exe')
  } else {
    // Linux
    return path.join(projectRoot, 'dist/linux-unpacked/project4')
  }
}
