/**
 * Prepare Node.js runtime for Mac ARM64 packaging
 * Downloads official Node.js macOS binary distribution
 *
 * Usage: node scripts/prepare-node-mac-arm64.mjs
 */
...
const NODE_DIR = path.resolve(__dirname, '../resources/node-arm64')
const NODE_VERSION = 'v20.18.2'  // LTS version
const DOWNLOAD_URL = `https://nodejs.org/dist/${NODE_VERSION}/node-${NODE_VERSION}-darwin-arm64.tar.gz`
...
function download(url, to) {
  ...
  // Find the extracted directory (node-vX.X.X-darwin-arm64)
...
async function main() {
  console.log('=== Preparing Node.js for Mac ARM64 ===\n')
