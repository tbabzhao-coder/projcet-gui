/**
 * Prepare lark-cli binary for macOS x64 packaging
 * Downloads from GitHub Release (with npmmirror fallback)
 *
 * Usage: node scripts/prepare-lark-cli-mac-x64.mjs
 */
...
const LARK_CLI_DIR = path.resolve(__dirname, '../resources/lark-cli-x64')
const VERSION = '1.0.4'
const NAME = 'lark-cli'
const ARCHIVE_NAME = `${NAME}-${VERSION}-darwin-amd64.tar.gz`
...
async function main() {
  console.log('=== Preparing lark-cli for macOS x64 ===\n')
