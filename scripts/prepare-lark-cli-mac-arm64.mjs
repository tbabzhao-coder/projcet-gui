/**
 * Prepare lark-cli binary for macOS arm64 packaging
 * Downloads from GitHub Release (with npmmirror fallback)
 *
 * Usage: node scripts/prepare-lark-cli-mac-arm64.mjs
 */
...
const LARK_CLI_DIR = path.resolve(__dirname, '../resources/lark-cli-arm64')
const VERSION = '1.0.4'
const NAME = 'lark-cli'
const ARCHIVE_NAME = `${NAME}-${VERSION}-darwin-arm64.tar.gz`
...
async function main() {
  console.log('=== Preparing lark-cli for macOS arm64 ===\n')
