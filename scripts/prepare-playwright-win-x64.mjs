/**
 * Prepare Playwright Chromium browser for Windows x64 packaging
 * Downloads Chromium to resources/playwright-browsers/ for bundling
 *
 * Usage: node scripts/prepare-playwright-win-x64.mjs
 */
...
async function main() {
  console.log('=== Preparing Playwright Chromium for Windows x64 ===\n')
